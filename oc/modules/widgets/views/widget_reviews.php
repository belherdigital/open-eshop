...
<?foreach($widget->review as $review):?>
    ...
    <div class="media">
        <a class="pull-left">
            <img class="media-object dp img-circle" src="<?=$review->user->get_profile_image()?>" data-toggle="tooltip" data-placement="top" title="<?=$review->user->name?>" style="width: 30px;height:30px;">
        </a>
