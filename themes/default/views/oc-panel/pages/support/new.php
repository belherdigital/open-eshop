<?php defined('SYSPATH') or die('No direct script access.');?>
	...
	<form class="well form-horizontal"  method="post" action="<?=Route::url('oc-panel',array('controller'=>'support','action'=>'new'))?>">         
      ...
      <div class="control-group">
        ...
        <div class="controls">
        <input  type="text" name="title" value="<?=core::post('title')?>" class="span6"  /> 
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
        <textarea name="description" rows="20" class="span6"><?=core::post('description')?></textarea>
        </div>
      </div>
