    ...
    <tbody>
        ...
        <?if($f['id_forum_parent'] == 0):?>
            <tr class="success">
                ...
                <td width="5%"><span class="label label-warning pull-right"><?=(isset($f['last_message'])?Date::format($f['last_message']):'')?></span></td>
                ...
                <?foreach($forums as $fhi):?>
                    ...
                    <tr>
                        ...
                        <th width="5%"><span class="label label-warning pull-right"><?=(isset($fhi['last_message'])?Date::format($f['last_message']):'')?></span></th>
